...
grid on;
xlim([0 N-1]);
title("$N = 256,\,L = 32$",'interpreter','latex');
xlabel("$0 <= k <= N-1$",'interpreter','latex');
ylabel("$|X[k]|$",'interpreter','latex');
...
grid on;
xlim([0 N-1]);
title("$N = 512,\,L = 64$",'interpreter','latex');
xlabel("$0 <= k <= N-1$",'interpreter','latex');
ylabel("$|X[k]|$",'interpreter','latex');
...
grid on;
xlim([0 N-1]);
title("$N = 1024,\,L = 128$",'interpreter','latex');
xlabel("$0 <= k <= N-1$",'interpreter','latex');
ylabel("$|X[k]|$",'interpreter','latex');
...
%{
    ...
    For Part G,
        ...
        *   For N = 16, L = 16, k = 3 and so f0 = 3*64/16 = 12
        *   For N = 32, L = 16, k = 5 and so f0 = 5*64/32 = 10
        *   For N = 64, L = 16, k = 11 and so f0 = 11*64/64 = 11
        *   For N = 128, L = 16, k = 22 and so f0 = 22*64/128 = 11
